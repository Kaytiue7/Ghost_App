...
public class MesajSayfa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new AdapterMessage(getContext(), messageList);
    ...
    private void getData() {
        firebaseFirestore.collection("Messages")
                ...
                .addSnapshotListener((value, error) -> {
                    if (value != null) {
                        messageList.clear(); // Yeni veriler eklenmeden önce listeyi temizle
...
/*/
                                ...
                                String pp = (String) data.get("profilePhoto");
                                 PostMessage post = new PostMessage(id, username, pp);
